...
%FIME: como é uma contribuição relevante do seu trabalho eu acho que isso deveria ser uma seção nova
...
%FIXME Importante enfatizar que as representações propostas são genéricas e podem servir como base para qualquer linguagem de sinais.
