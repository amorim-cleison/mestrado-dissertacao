...
\label{sec:metodologia-selecao-modelos}
...
Tomando como base a discussão apresentada acima, para este trabalho selecionamos a arquitetura \textit{Encoder-Decoder} implementada em duas versões utilizando \textit{attention} -- uma utilizando \acrshort{lstm} e outra com \acrshort{gru} -- e também o \textit{Transformer}.
