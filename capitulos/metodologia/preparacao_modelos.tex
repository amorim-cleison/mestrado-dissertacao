...
%FIXME: essa parte ficaria na metodologia se vc tirar a os datasets para uma nova secao
...
\begin{figure}[ht!]
    ...
    \borda[\textwidth]{
        ...
        \subcaptionbox{Nº de cabeças\label{subfig:otim-transformer-heads}}{
            \includegraphics[width=5.0cm]{capitulos/metodologia/imagens/otim_transformer_heads}
        }%
    }
    \nomefonte{}
