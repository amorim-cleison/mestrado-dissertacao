...
Muito frequentemente, algoritmos de \acrshort{slr} são treinados em \textit{dataset}s que não refletem casos de uso reais -- como, por exemplo, no reconhecimento de mãos estáticas individuais fora do contexto do sinalizador. Todos esses fatores resultam em abordagens que têm um valor bastante limitado no mundo real.
