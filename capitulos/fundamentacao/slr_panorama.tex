...
\input{capitulos/fundamentacao/tabelas/sinais-isolados-continuos}
...
\subsubsection{Línguas de sinais abordadas}
...
\input{capitulos/fundamentacao/tabelas/linguas-sinais.tex}
...
\input{capitulos/fundamentacao/tabelas/dados-entrada-tipos}
...
A \autoref{tab:parametros-tipos} mostra a proporção dos tipos de parâmetros com relação ao total de estudos identificados, agrupados em ordem cronológica de intervalos de cinco anos. 
