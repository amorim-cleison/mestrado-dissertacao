...
Ele foi introduzido por \citeonline{vaswani-2017-transformer} e sua estrutura é composta por blocos empilhados de redes multicamadas que combinam camadas lineares simples, redes \textit{feed-forward} e camadas de \textit{self-attention} (ou auto-atenção) -- as quais são a principal inovação aqui --, conforme ilustra a \autoref{fig:transformer-arquitetura}.
...
%FIXME: acho que a legenda poderia guiar um pouco o leitor sobre a imagem, ela é bem complexa para alguem que nao conhece entender. eu sei que vc falou no texto, mas trazer do texto pra legenda talvez fosse uma boa estratégia
