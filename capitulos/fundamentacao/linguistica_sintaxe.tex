...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \figura[p. 187]
            ...
            {imagens/fundamentacao/interrogativa_joao_gostar} % Path
            {height=4cm} % Size
        ...
        \figura[p. 121]
            ...
            {imagens/fundamentacao/condicional_chover_jogo_cancelar} % Path
            {height=5cm} % Size
        ...
        \figura[p. 147]
            ...
            {imagens/fundamentacao/topicalizada_futebol_gostar} % Path
            {height=4cm} % Size
    ...
    \figura[p. 147]
        ...
        {imagens/fundamentacao/negacao_futebol_gostar_nao} % Path
        {height=4cm} % Size
