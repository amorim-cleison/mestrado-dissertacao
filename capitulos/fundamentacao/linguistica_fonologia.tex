...
% %FIXME: é locação ou enunciação? --> nos livros sobre linguística (em português) que usei eles acabam usando (ou traduzindo) como locação. daí acabei seguindo o padrão deles.
