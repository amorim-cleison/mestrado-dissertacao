    ...
    \resizebox{0.90\textwidth}{!}{%
        \begin{tabular}{l|l|c|c}
            ...
            \multirow{-2}{*}{\citeonline{amorim-2019-stgcn-sl}} & \acrshort{stgcn}                & 2.745          & 16,48\%           \\ \hline
                                                                & \textbf{Encoder-Decoder (LSTM)} & \textbf{2.650} & \textbf{42,56\%}  \\
                                                                & \textbf{Encoder-Decoder (GRU)}  & \textbf{2.650} & \textbf{42,78\%}  \\
            \multirow{-3}{*}{\textbf{Proposta atual}}           & \textbf{Transformer}            & \textbf{2.650} & \textbf{99,56\%} \\ \hline
        \end{tabular}%
    }
    \nomefonte{}
\end{table}