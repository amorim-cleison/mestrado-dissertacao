...
\begin{table}[]
    ...
    \cellcolor[HTML]{EFEFEF}\textbf{Artigo}                       & \textbf{Técnica}                        & \textbf{Nº Sinais} & \textbf{Acurácia}  \\ \hline
    ...
    \textbf{(Proposta atual)}                                     & \textbf{Encoder-Decoder (GRU)}          & \textbf{Todos}     & \textbf{?}         \\
    \textbf{(Proposta atual)}                                     & \textbf{Encoder-Decoder (LSTM)}         & \textbf{Todos}     & \textbf{?}         \\ \hline
    \end{tabular}%
    }
    \end{table}