...
% %FIXME: [cz] talvez precise atualizar essa referencia, pq é uma afirmação forte, feita a mais de 10 anos. eu realmente acho que ainda está assim, mas era bom uma referencia mais recente --> [cca5] feito adicionei uma mais recente acima
\begin{citacao}
...
% %FIXME: [cz] acho que vc precisa de mais um paragrafo aqui enfatizando pq é um problema nao considerar a parte linguistica. vc falou bastante do contexto do surdo, mas pouco do problema que vc vai abordar --> [cca5] feito
