...
\begin{itemize}
    ...
    \item Disponibilizar um \textit{dataset} de atributos linguísticos, o qual atualmente é inexistente, para suportar o desenvolvimento de novas técnicas para as línguas de sinais;
          ...
          % %FIXME: [cz] vc disse anteriormente que era importante considerar a lingua como um todo, visto que ela era visual, mas seu ultimo objetivo especifico fala somente de NLP. nao precisa contextualizar melhor q vc considera mais coisa? --> [cca5] feito
