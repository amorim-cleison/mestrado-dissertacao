...
\begin{itemize}
    ...
    %\item Disponibilizar um \dataset com coordenadas tridimensionais dos sinalizadores que possibilite a exploração de outras abordagens de geração de atributos linguísticos;
