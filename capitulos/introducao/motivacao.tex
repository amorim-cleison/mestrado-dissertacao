...
\citeauthor{bragg-2019-slr-interdisciplinary} e \citeauthor{cooper-2011-slr} acreditam que, de uma forma geral, isso está relacionado a fatores como a abordagem inadequada do problema pelas pesquisas nessa área -- o que faz com que elas tenham um valor limitado no mundo real -- e também aos desafios particulares apresentados pelas línguas visuais. 
Em resumo, podemos enumerar esses itens da seguinte forma:

\begin{enumerate}
    \item Abordagem inadequada: pesquisas atuais em processamento de linguagem de sinais ocorrem em silos disciplinares e, como resultado, não abordam o problema de uma forma abrangente. Por exemplo, há muito mais publicações com apresentam algoritmos para reconhecer (e menos frequentemente para traduzir) conteúdo sinalizado.
    Além disso, muitas delas encaram o reconhecimento da língua de sinais como uma tarefa de reconhecimento de gestos, concentrando-se na identificação de características e métodos para rotular um sinal dentre um conjunto de possibilidades bem definidas -- porém, essas línguas vão muito além disso.

    \item Equipes inexperientes no problema: muitas equipes carecem de membros surdos com experiência vivida nos problemas em questão ou que conheçam as complexidades linguísticas com as quais seus algoritmos deveriam lidar.
    ...
    % frequentemente também são utilizados \textit{datasets} que não refletem casos de uso do mundo real
\end{enumerate}
