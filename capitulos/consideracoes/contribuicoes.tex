...
Entre as principais contribuições produzidas por este trabalho, podemos enumerar que ele:
...
\begin{itemize}
    ...
    \item Traz clareza acerca das principais lacunas que têm limitado progressos expressivos na área de \acrshort{slr} ao longo das últimas décadas, os quais poderiam viabilizar soluções efetivamente aplicáveis ao contexto real da língua de sinais e do Surdo. % Isso é alcançado através da análise de revisões literárias das últimas décadas de pesquisas. 
